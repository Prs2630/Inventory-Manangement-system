...
const Product = () => {
  ...
  const options = [, 'name', 'price', 'quantity', 'category', 'supplier', 'brand', 'color', 'size']
  ...
  const addToCart = (data,index) => {
    ...
    if(!addedPrduct)
    {
      ...
      alert(` ${data.name} has been added to cart`)
    }
              ...
              <Table aria-label="simple table">
                <TableHead>
                  <TableRow>
                    ...
                    <StyledTableCell align="center">total_quantity</StyledTableCell>
                    <StyledTableCell align="center">category</StyledTableCell>
                    <StyledTableCell align="center">supplier</StyledTableCell>
                    <StyledTableCell align="center">brand</StyledTableCell>
                    <StyledTableCell align="center">color</StyledTableCell>
                    <StyledTableCell align="center">size</StyledTableCell>
                    <StyledTableCell align="center">selected_quant</StyledTableCell>
                  ...
                  {val.map((row, index) => (
                    row.quantity > 0 ?
                      ...
                      >
                        ...
                        <StyledTableCell align="center"><input type="number" min='1' defaultValue={0}  max={row.quantity} onChange={(event) =>setCount(event.target.value)} /></StyledTableCell>
